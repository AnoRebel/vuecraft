...
const DEVICE_PRESETS: DevicePreset[] = [
  ...
  { id: 'iphone-14', name: 'iPhone 14', width: 390, height: 844, icon: 'smartphone', category: 'mobile' },
  { id: 'iphone-14-pro-max', name: 'iPhone 14 Pro Max', width: 430, height: 932, icon: 'smartphone', category: 'mobile' },
  { id: 'pixel-7', name: 'Pixel 7', width: 412, height: 915, icon: 'smartphone', category: 'mobile' },
  { id: 'samsung-s23', name: 'Samsung S23', width: 360, height: 780, icon: 'smartphone', category: 'mobile' },
  ...
  { id: 'laptop-lg', name: 'Laptop Large', width: 1440, height: 900, icon: 'laptop', category: 'desktop' },
  { id: 'desktop', name: 'Desktop', width: 1920, height: 1080, icon: 'monitor', category: 'desktop' },
  { id: 'desktop-lg', name: 'Desktop Large', width: 2560, height: 1440, icon: 'monitor', category: 'desktop' },
]
